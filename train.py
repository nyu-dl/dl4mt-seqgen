...
def get_parser():
    ...
    parser.add_argument("--save_latest_ckpts", type=int, default=0,
                        help="Number of latest checkpoints to keep track of (i.e. to save) (0 to disable)")
    ...
    parser.add_argument("--word_pred_uniform", action='store_true',
                        help="Uniformly sample a fraction of words from 0 to 100 instead of fixed rate")
    ...
    parser.add_argument("--add_langemb_everylayer", type=bool_flag, default=False,
                        help="Add language embedding to the output of every layer (before final layernorm)")
    ...
    parser.add_argument("--data_path", type=str, default="",
                        help="Data path")
    parser.add_argument("--distill_data_path_lang1", type=str, default="",
                        help="Data from a distilled autoregressive model for lang1")
    parser.add_argument("--distill_data_path_lang2", type=str, default="",
                        help="Data from a distilled autoregressive model for lang1")
    ...
    parser.add_argument("--label_smoothing", type=float, default=0.0,
                        help="Use label smoothings (0 to disable)")
    ...
    parser.add_argument("--reload_optimizer", type=bool_flag, default=False,
                        help="Reload an optimizer")
    ...
    # mask out tokens from the other langs (during evaluation only)
    parser.add_argument("--mask_other_lang", type=bool_flag, default=False,
                        help="Only run evaluations")
    # debug
